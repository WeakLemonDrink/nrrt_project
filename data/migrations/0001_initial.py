    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ManyToManyField(to='data.Item')),
            ],
        ),
        migrations.CreateModel(
            name='RankingCluster',
            fields=[
                ...
                ('master_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.item')),
            ],
        ),
        migrations.CreateModel(
            name='Measure',
            fields=[
                ...
                ('value_dtype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.datatype')),
            ],
        ),
        migrations.CreateModel(
            name='InstanceLink',
            fields=[
                ...
                ('relationship', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.relationship')),
            ],
        ),
        migrations.CreateModel(
            name='Instance',
            fields=[
                ...
                ('abm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.abstractbasemodel')),
                ('iil', models.ManyToManyField(to='data.IncomingInteractionLink')),
                ('link', models.ManyToManyField(to='data.InstanceLink')),
            ],
        ),
        migrations.CreateModel(
            name='Attribute',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attribute_name', models.CharField(max_length=140, unique=True)),
                ('value_dtype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.datatype')),
            ],
        ),
        migrations.AddField(
            model_name='abstractbasemodel',
            name='attribute',
            field=models.ManyToManyField(to='data.Attribute'),
        ),
        migrations.AddField(
            model_name='abstractbasemodel',
            name='link',
            field=models.ManyToManyField(to='data.ABMLink'),
        ),
        migrations.AddField(
            model_name='abstractbasemodel',
            name='master_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.item'),
        ),
        migrations.AddField(
            model_name='abstractbasemodel',
            name='measure',
            field=models.ManyToManyField(to='data.Measure'),
        ),
        migrations.AddField(
            model_name='abmlink',
            name='relationship',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.relationship'),
        ),
    ]
